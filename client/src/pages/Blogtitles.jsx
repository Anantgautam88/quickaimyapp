...
{/* left column */}
          ...
          {
            loading ? <span className='w-4 h-4 my-1 rounded-full border-2 border-transparent animate-spin'> </span> :  
            <Hash className='w-5'/>
          }
    ...
    Generated Titles
...

       {
        !content ? (<div className='flex-1 flex justify-center items-center'>
          ...
          <p>Enter a topic and click "Generate Title" to create a list of Titles based on that topic.</p>
          </div>

...
const handlesubmit=async(e)=>{
  ...
  return (
    ...
    {/* left column */}
               ...
               <textarea onChange={(e)=>setobject(e.target.value)} value={object} rows={4} type='text' className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300' placeholder='eg. watch of spoon , only single object name  ' required/>

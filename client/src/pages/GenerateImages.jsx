...
{/* left column */}
         ...
         <p className='text-sm'>Make this image public </p>
           ...
           <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00ad25] to-[#04ff50] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
            ...
            {
              loading ? <span className='w-4 h-4 my-1 rounded-full border-2 border-transparent animate-spin'></span> :  <Image className='w-5'/>
            }
    ...
    Generated Image
...

       {
        !content ? (<div className='flex-1 flex justify-center items-center'>
          ...
          <p>Enter a topic and click "Generate Image" to create a Image based on that topic.</p>
          </div>
